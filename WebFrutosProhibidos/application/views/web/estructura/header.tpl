...
<html lang="es">
    <head>
        ...
        <link rel="icon" href="{$base_url}public/img/logo/isotipo_color.png" type="image/x-icon" />
        <link rel="shortcut icon" href="{$base_url}public/img/isotipo_color.png" type="image/x-icon" />
